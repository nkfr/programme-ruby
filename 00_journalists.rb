...
#Le handle le plus court de cette liste
puts "Question 2 : Quelle est le handle le plus court de cette liste ?"
print "> "
puts handle.min_by(&:length)

#Nombre de handle contenant 5 caractères
puts " Question 3 : Combien y-a-t'il de handle contenant 5 caractères"
print "> "
n = 0
...
#Nombre de handle commençant par une majuscule (première lettre juste après le @) ?
puts " Question 4 : Combien commencent par une majuscule (première lettre juste après le @) ?"
print "> "
a = 0
handle.each do |hand|
	if hand[1] == hand[1].upcase
		a += 1
	end
end
puts a 
...
print "> "
print handle.sort { |w1, w2| w1.casecmp(w2) }
puts ""

#Trie la liste de handle par taille des handle
puts "Question 6 : Trie la liste de handle par taille des handle (les plus petits en premiers, les plus grands après)"
print "> "
print handle.sort_by(&:length)
puts ""

#La position dans l'array de la personne @epenser ?
puts "Quelle est la position dans l'array de la personne @epenser ?"
print "> "
puts handle.find_index("@epenser")

# Répartition des handle par taille 
puts "Sors-moi une répartition des handle par taille de ces derniers"
print "> "
puts handle.group_by(&:length).transform_values(&:count)
